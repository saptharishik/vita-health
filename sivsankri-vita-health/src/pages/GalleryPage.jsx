      ...
      <div className="feedback-wrap" id="testimonials">
        <div className="sec">
          ...
          <div className="feedback-grid">
            {[
              { initials: 'R', name: 'Mrs. Raghavi', role: 'Parent — Community Workshop', color: '#2d6a2d', stars: 5, text: '"Thank you so much, Akka, for the wonderful session for the kids and the mini get-together! It was great learning a new skill to help nurture the kids. We\'ve already started our first project with mustard seed. Looking forward to see them grow!!!!"' },
              { initials: 'P', name: 'Mrs. Praba', role: 'Housewife', color: '#1a7560', stars: 5, text: '"Nice session, clear cut explanation with live demo helps to understand about Microgreens for the beginners...informative and interesting session, helps to lead our life healthy. Thank you Hema."' },
              { initials: 'D', name: 'Deepa D', role: 'Working Professional', color: '#b8860b', stars: 5, text: '"I liked the seminar the most because it clearly explained the benefits of microgreens and how to grow them easily at home."' },
              { initials: 'WP', name: 'Participant', role: 'Working Professional', color: '#4a3db8', stars: 5, text: '"Very clear step by step explanation with ppt and sharing the live demo was useful."' },
              { initials: 'PV', name: 'Dr. Pallavi Vaze', role: 'Workshop Participant', color: '#1a5c8a', stars: 5, text: '"The detailed explanation about growing the micro greens and promoting DIY."' },
              { initials: 'SR', name: 'Student Participant', role: 'Prasan Vidya Mandir, Mamandur — Class 6', color: '#0a6b3a', stars: 5, text: '"It\'s a wonderful opportunity to learn about the microgreens. Part of healthy life. I actively participated in sowing the seeds and daily observation. I enjoyed the activity and would love to do similar hands-on activities again!"' },
              { initials: 'ST', name: 'Science Teacher', role: 'The Ashok Leyland School, Hosur', color: '#5a2d82', stars: 5, text: '"The activity enhanced students\' understanding of plant growth, nutrition, and sustainable practices. It also encouraged entrepreneurial thinking, responsibility, teamwork, and practical learning. About 60–70% of the students successfully completed the task, brought their microgreens to school, and included them in their diet."' },
            ].map((fb, i) => (
